...
function App() {
    ...
    const [noData, setNoData] = React.useState("No date yet");
    const [searchTerm, setSearchTerm] = React.useState("");
    const [weatherData, setWeatherData] = React.useState([]);
    const [city, setCity] = React.useState("unknow location");
    ...
    return (
        <div className='bg-gray-800 flex items-cent justify-center w-screen h-screen py-0'>
                    ...
                    <div className='flex flex-col my-10'>
                        {weatherData.length === 0 ? (
                            ...
                            <>
                                ...
                                <h2 className='text-3xl text-gray-600 mb-4 mt-10'>
                                    More on {city}
                                </h2>
